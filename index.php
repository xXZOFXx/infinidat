            ...
            <div class="background">
                    ...
                    <div class="imagen">
                      <div class="inic">
                        <div class="col inicio">
                          <h1 class="h1"> Habilite y potencie su ventaja competitiva basada en datos a gran escala.</h1>
                        </div>
              ...
              <div class="col cuadro">
                ...
                <div class="container">
                    ...
                    <h2> <strong>INFINIDAT</strong> fue nombrado en noviembre del 2018 como jugador líder en el cuadrante de Gartner en la categoría de Disk-Arrays de propósito general. </h2>


                      <div class="col align-self-center magic" align="center" >
                        <img class="box" src="images/cuadro.png" width="500" height="500" alt="">
                          </div>
              ...
              <div class="col-md-12 cartas">

                <div class="card-deck">
                          <div class="card">
                            <img class="card-img-top" src="images/infinibox.svg" width="90" height="90" alt="Card image cap">
                            <div class="card-body">
                              <h5 class="card-title"><b>InfiniBox</b></h5>
                              <p class="card-text">    El almacenamiento empresarial InfiniBox ofrece un rendimiento más rápido que cualquier arreglo all flash, alta disponibilidad y capacidad de varios petabytes para cargas de trabajo de aplicaciones mixtas. Snapshot con impacto cero, la replicación síncrona, la replicación asíncrona y el cifrado de datos en reposo aseguran la máxima confiabilidad y seguridad de los datos.  </p>
                          ...
                          <div class="card">
                            <img class="card-img-top" src="images/infiniguard.svg" width="90" height="90" alt="Card image cap">
                            <div class="card-body">
                              <h5 class="card-title"><b>InfiniGuard</b></h5>
                              <p class="card-text">InfiniGuard ofrece una velocidad y confiabilidad inigualables en el respaldo de datos y la capacidad de restauración para la continuidad del negocio de alto rendimiento y la recuperación de desastres. Construido con el InfiniBox® líder en el mercado para optimizar el rendimiento y el procesamiento de deduplicación, InfiniGuard le permite maximizar la capacidad efectiva para entornos de múltiples petabytes. </p>
                          ...
                          <div class="card">
                              <img class="card-img-top" src="images/infinisync.svg" width="90" height="90" alt="Card image cap">
                                    <div class="card-body">
                                    <h5 class="card-title"><b>InfiniSync</b></h5>
                                    <p class="card-text">InfiniSync es una solución altamente resistente de cero pérdidas de datos. Permite un RPO de cero, simple y rentable con una topología de dos centros de datos. InfiniSync resuelve las limitaciones de la replicación sincrónica (latencia) y la replicación asincrónica (Objetivo del punto de recuperación), proporcionando integridad completa de los datos a cualquier distancia. </p>
                                      </div>
                                    ...
                                    <div class="card">
                                        <img class="card-img-top" src="images/neutrix.svg" width="90" height="90" alt="Card image cap">
                                            <div class="card-body">
                                                <h5 class="card-title"><b>Neutrix Cloud</b></h5>
                                                      <p class="card-text">    El servicio de almacenamiento Neutrix Cloud de Infinidat libera sus datos de las arquitecturas cerradas de las nubes públicas individuales, para que pueda ejecutar sus cargas de trabajo donde tienen más sentido sin penalizaciones económicas. </p>
                                                            </div>
